...
export default function AdminSidebar({ open = true, onClose }: { open?: boolean; onClose?: () => void }) {
  ...
  return (
    <aside className={`sidebar-shell flex h-screen w-[274px] flex-col px-3 py-3 text-white transition-all duration-300 ${open ? 'relative shrink-0' : 'absolute -left-full'}`}>
